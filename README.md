...
## Contents
- `paper/` – LaTeX source of the main theoretical paper
- `src/` – Reference implementation of the core objects (hierarchy, projectors, foam, gradient descent)
- `examples/` – Small experiments illustrating superposition of opposites and multi-level nullification
